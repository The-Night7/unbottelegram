...
FLOORS = {
    ...
    "Floor 4 - Rovia": {
        ...
        "boss_defeated": False,
        "unlock_requirement": "Vaincre Nerius the Evil Treant"
    },
    "Floor 5 - Karluin": {
        "unlocked": False,
        "boss": "Fuscus the Vacant Colossus",
        "boss_defeated": False,
        "unlock_requirement": "Vaincre Wythege the Hippocampus"
    },
    "Floor 10 - Coral": {
        "unlocked": False,
        "boss": "Kagachi the Samurai Lord",
        "boss_defeated": False,
        "unlock_requirement": "Niveau 15"
    },
    ...
    "Floor 25 - Labyrinth": {
        "unlocked": False,
        "boss": "The Demonic Servant",
        "boss_defeated": False,
        "unlock_requirement": "Niveau 40"
    },
    "Floor 40 - Jaileum": {
        "unlocked": False,
        "boss": "Vemacitrin the Absolute",
        "boss_defeated": False,
        "unlock_requirement": "Niveau 50"
    },
    "Floor 50 - Algade": {
        "unlocked": False,
    ...
    "Floor 60 - Selmburg": {
        "unlocked": False,
        "boss": "The Dimensional Reaper",
        "boss_defeated": False,
        "unlock_requirement": "Niveau 65"
    },
    "Floor 75 - Boss Room": {
        "unlocked": False,
    ...
    "Floor 90 - Crimson Keep": {
        "unlocked": False,
        "boss": "The Crimson King",
        "boss_defeated": False,
        "unlock_requirement": "Niveau 85"
    },
    "Floor 100 - Ruby Palace": {
        "unlocked": False,
        "boss": "Heathcliff, The Final Guardian",
        "boss_defeated": False,
        "unlock_requirement": "Vaincre tous les boss précédents"
    }
}
...
async def handle_location(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # List of valid locations to avoid handling other text messages
    valid_locations = [
        "Town of Beginnings",
        "Floor 1 - Tolbana",
        "Floor 2 - Urbus",
    ...
    # Only process if it's a valid location
...
def main() -> None:
    ...
    application.add_handler(CommandHandler("profile", profile_command))  # Changed from profile to profile_command
    ...
    application.add_handler(CommandHandler("boss", boss_command))  # Changed from boss_handler to boss_command
    ...
    # Make it more specific to avoid conflicts with other handlers
    application.add_handler(MessageHandler(
        filters.TEXT & ~filters.COMMAND & filters.Regex(
            '^(Town of Beginnings|Floor 1 - Tolbana|Floor 2 - Urbus|Floor 3 - Forest of Wandering|Floor 22 - Forest House|Floor 50 - Algade|Floor 55 - Grandzam|Floor 75 - Boss Room)$'),
        handle_location
    ))
